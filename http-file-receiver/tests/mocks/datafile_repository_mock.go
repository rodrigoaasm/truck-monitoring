...
import (
	...
	entities "github.com/rodrigoaasm/truck-monitoring/http-file-receiver/internal/domain/entities"
)
...
func (m *MockDataFileRepositoryInterface) PutDatafile(fileReader io.Reader, datafileEvent entities.DatafileUploadEvent) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PutDatafile", fileReader, datafileEvent)
	ret0, _ := ret[0].(error)
	return ret0
}

// PutDatafile indicates an expected call of PutDatafile.
func (mr *MockDataFileRepositoryInterfaceMockRecorder) PutDatafile(fileReader, datafileEvent interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PutDatafile", reflect.TypeOf((*MockDataFileRepositoryInterface)(nil).PutDatafile), fileReader, datafileEvent)
}
